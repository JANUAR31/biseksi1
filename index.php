...
<div class="container">
<p>
  Carilah akar persamaan <strong>x<sup>3</sup>+3x-5=0.</strong></p> <p>
  <strong>erorr = 0,01</strong></p>
<?php
...
?>
        <tr bg-color="#FFFFFF">
          <td align="center"><?php echo $k;?></td>
            <td align="center"><?php echo number_format($b, 7, ",", ".");?></td>
            <td align="center"><?php echo number_format($a, 7, ",", ".");?></td>
            <td align="center"><?php echo number_format($x, 7, ",", ".");?></td>
            <td align="center"><?php echo number_format($fx, 7, ",", ".");?></td>
            <td align="center"><?php echo number_format($fb, 7, ",", ".");?></td>
